...
Namespace Standard
 ...
 Public Structure Material
  ...
  Public Shared Operator =(ByVal L As Material, ByVal R As Material) As Boolean
   If (L.m_MaterialName = R.m_MaterialName) AndAlso _
      (L.m_Attributes.Equals(R.m_Attributes)) AndAlso _
      (L.m_TextureName = R.m_TextureName) AndAlso _
  ...
  ''' </returns>
  Public Shared Operator <>(ByVal L As Material, ByVal R As Material) As Boolean
   If (L.m_MaterialName <> R.m_MaterialName) OrElse _
      (Not L.m_Attributes.Equals(R.m_Attributes)) OrElse _
      (L.m_TextureName <> R.m_TextureName) OrElse _
  ...
  ''' Modified material.
  ''' </returns>
  Public Function SetMaterialName(ByVal V As String) As IMaterial Implements MaterialFields.IMaterialName.SetMaterialName
   m_MaterialName = V
   Return Me
  ...
  ''' </remarks>
  Private Function GetTextureName(Optional ByVal Index As Integer = 0) As String Implements MaterialFields.IMaterialTexture.GetTextureName
   Return m_TextureName
  ...
  ''' All values of index point to the same texture.
  ''' </remarks>
  Public Function SetTextureName(ByVal V As String, Optional ByVal Index As Integer = 0) As IMaterial Implements MaterialFields.IMaterialTexture.SetTextureName
   m_TextureName = V
   Return Me
  ...
  ''' </summary>
  Private Function GetAttributes() As Direct3D.Material Implements MaterialFields.IMaterialAttributes.GetAttributes
   Return m_Attributes
  ...
  ''' Modified material.
  ''' </returns>
  Public Function SetAttributes(ByVal V As Direct3D.Material) As IMaterial Implements MaterialFields.IMaterialAttributes.SetAttributes
   m_Attributes = V
   Return Me
