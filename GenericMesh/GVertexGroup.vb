...
Public NotInheritable Class GVertexGroup (Of VertexType As {Structure, IVertex})
    ...
    Public Function Append (Of InVertexType As {Structure, IVertex}) _
        (ByVal VertexData() As InVertexType,
    ...
    ''' </remarks>
    Public Function Append (Of InVertexType As {Structure, IVertex}) _
        (ByVal obj As GVertexGroup(Of InVertexType),
         Optional ByVal _Converter As System.Converter(Of InVertexType, VertexType) = Nothing) As Boolean
    ...
    Public Function CopyTo (Of OutVertexType As {Structure, IVertex}) _
        ...
        If GetType(OutVertexType) Is GetType(VertexType) Then
            ' Copy directly.
            ' --------------
            m_Vertices.CopyTo(SourceIndex,
                              CType(CObj(P), VertexType()),
                              DestinationIndex,
                              Length)
    ...
    ''' </remarks>
    Public Function CopyTo (Of OutVertexType As {Structure, IVertex}) _
        (ByVal obj As GVertexGroup(Of OutVertexType),
         Optional ByVal _Converter As System.Converter(Of VertexType, OutVertexType) = Nothing) As Boolean
    ...
    Public Function Transform(ByVal M As Matrix,
                              Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing,
    ...
    ''' Thrown when <c>StartIndex</c> or <c>EndIndex</c> is out of bounds.
    ''' </exception>
    Public Function TransformRange(ByVal M As Matrix,
                                   ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType),
    ...
    Public Function ProcessVertices (Of DataType As {Structure}) _
        (ByVal P() As DataType,
         ByVal _VP As Utility.VertexProcessor(Of DataType, VertexType),
         Optional ByVal StartIndex As Integer = 0,
         Optional ByVal PBaseIndex As Integer = 0,
         Optional ByVal Count As Integer = - 1) As Boolean
    ...
    ''' </returns>
    Friend Function WriteDataToBuffer(ByVal VB As VertexBuffer, ByVal LockAtOffsetInBytes As Integer,
