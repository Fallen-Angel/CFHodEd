...
''' </typeparam>
Public NotInheritable Class GMeshPart(Of VertexType As {Structure, IVertex}, _
 ...
 Public ReadOnly Property TotalIndiceCount() As Integer
  Get
   Return m_PrimitiveGroups.Aggregate( _
           0, _
 ...
 Public Function AddPrimitiveGroup(Of InIndiceType As {Structure, IConvertible}) _
                                  (ByVal P As GPrimitiveGroup(Of InIndiceType), _
 ...
 Public Function Append(Of InVertexType As {Structure, IVertex}, _
                       ...
                       (ByVal obj As GMeshPart(Of InVertexType, InIndiceType, InMaterialType), _
                        Optional ByVal _VC As System.Converter(Of InVertexType, VertexType) = Nothing, _
 ...
 Public Function CopyTo(Of OutVertexType As {Structure, IVertex}, _
                       ...
                       (ByVal obj As GMeshPart(Of OutVertexType, OutIndiceType, OutMaterialType), _
               Optional ByVal _VC As System.Converter(Of VertexType, OutVertexType) = Nothing, _
               Optional ByVal _IC As System.Converter(Of IndiceType, OutIndiceType) = Nothing, _
 ...
 : Exit Function
  ...
  m_PrimitiveGroups.ForEach( _
   Function(V As GPrimitiveGroup(Of IndiceType)) _
    (obj.AddPrimitiveGroup(V, _IC)) _
  )
 ...
 ''' </exception>
 Public Function RemovePrimitiveGroups(ByVal Index As Integer, _
 ...
 ''' </exception>
 Public Function RemovePrimitiveGroupsRange(ByVal StartIndex As Integer, _
 ...
 Public Function Transform(ByVal M As Matrix, _
                  Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Translation(ByVal X As Single, ByVal Y As Single, ByVal Z As Single, _
                    Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Translation(ByVal V As Vector3, _
                    Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Rotation(ByVal X As Single, ByVal Y As Single, ByVal Z As Single, _
                Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean

  Return m_Vertices.Transform((Matrix.RotationX(X) * _
                               Matrix.RotationY(Y) * _
                               Matrix.RotationZ(Z)), _
                               _VertexTransformer)
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Rotation(ByVal V As Vector3, _
                 Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean

  Return m_Vertices.Transform((Matrix.RotationX(V.X) * _
                               Matrix.RotationY(V.Y) * _
                               Matrix.RotationZ(V.Z)), _
                               _VertexTransformer)
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Scaling(ByVal X As Single, ByVal Y As Single, ByVal Z As Single, _
                Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean
 ...
 ''' Function to be used for performing transformation.
 ''' </param>
 Public Function Scaling(ByVal V As Vector3, _
                Optional ByVal _VertexTransformer As Func(Of VertexType, Matrix, VertexType) = Nothing) As Boolean
 ...
 Public Function Weld() As Boolean
  ...
  If (m_Vertices.Count = 0) OrElse _
     (m_PrimitiveGroups.Count = 0) OrElse _
 ...
 : Exit Function
  ...
  For I As Integer = 0 To m_PrimitiveGroups.Count - 1
   ...
   If (m_PrimitiveGroups(I).Type = PrimitiveType.PointList) OrElse _
      (m_PrimitiveGroups(I).Type = PrimitiveType.LineList) OrElse _
   ...
   For J As Integer = 0 To UBound(Ind) Step 3
    ...
    ' Check indices.
    If (Ind1 < 0) OrElse (Ind2 < 0) OrElse (Ind3 < 0) OrElse _
 ...
 ''' <c>Nothing</c>.
 ''' </exception>
 Public Function Render(ByVal Device As Direct3D.Device, ByVal VB As VertexBuffer, ByVal IB As IndexBuffer, _
 ...
 : Exit Function
  ...
  If (BaseVertexOffset < 0) OrElse (BaseIndiceOffset < 0) Then _
   Throw New ArgumentOutOfRangeException(CStr(IIf( _
                                                  BaseVertexOffset < 0, _
                                                  "BaseVertexOffset", _
                                                  "BaseIndiceOffset" _
                                                 ))) _
 : Exit Function
 ...
 : Exit Function
  ...
  With Device
   ...
   For I As Integer = 0 To m_PrimitiveGroups.Count - 1
    Dim minVtxIndex As Integer = 0, _
    ...
    If (m_PrimitiveGroups(I).Type = PrimitiveType.TriangleStrip) OrElse _
    ...
    ' Draw the primitive.
    .DrawIndexedPrimitives( _
                           m_PrimitiveGroups(I).Type, _
                           BaseVertexOffset, _
                           minVtxIndex, _
                           maxVtxIndex - minVtxIndex + 1, _
                           BaseIndiceOffset + Offset, _
                           m_PrimitiveGroups(I).PrimitiveCount _
                          )
 ...
 : Exit Function
  ...
  For I As Integer = 0 To m_PrimitiveGroups.Count - 1
   ...
   _Device.DrawIndexedUserPrimitives(m_PrimitiveGroups(I).Type, _
                                     0, _
                                     m_Vertices.Count, _
                                     m_PrimitiveGroups(I).PrimitiveCount, _
                                     m_PrimitiveGroups(I).GetData(), _
                                     CBool(Len(Ind) = 2), _
                                     m_Vertices.GetData() _
                                    )
