...
Partial Class GBasicMesh(Of VertexType As {Structure, IVertex}, _
 ...
 ''' are reversed.
 ''' </remarks>
 Public Sub CreatePlane(ByVal SizeX As Single, ByVal SizeY As Single, _
               Optional ByVal SubdivisionX As Integer = 4, _
               Optional ByVal SubdivisionY As Integer = 4, _
               Optional ByVal DoubleSided As Boolean = False, _
 ...
 Public Sub CreatePlane(ByVal SizeX As Single, ByVal SizeY As Single, _
                        ...
                        ByVal ColourMin As ColorValue, ByVal ColourMax As ColorValue, _
               Optional ByVal ReverseFaces As Boolean = False, _
               Optional ByVal RemovePrevData As Boolean = False, _
               Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
               Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing)
 ...
 ''' (in space).
 ''' </remarks>
 Public Sub CreatePlane(ByVal SizeXUp As Single, ByVal SizeXDown As Single, ByVal SizeY As Single, _
                        ByVal SubdivisionX As Integer, ByVal SubdivisionY As Integer, _
  ...
  M = MeshTemplates.CreatePlane(SizeXUp, SizeXDown, SizeY, _
                                SubdivisionX, SubdivisionY, _
                                ColourUp, ColourDown, _
                                AlignLeft, AlignRight, _
 ...
 ''' Indice converter to add indice data.
 ''' </param>
 Public Sub CreatePolygon(ByVal EdgeLength As Single, ByVal EdgeCount As Integer, _
                 Optional ByVal DoubleSided As Boolean = False, _
                 Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
                 Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing)
 ...
 : Exit Sub
  ...
  ' Create the polygon.
  CreatePolygonA(EdgeLength / (2.0F * CSng(Math.Sin(Math.PI / EdgeCount))), _
                 EdgeCount, _
                 ColourCenter, _
                 ColourRim, _
                 AngleOffsetInDegrees, _
                 AngleSizeInDegrees, _
                 ReverseFaces, _
                 RemovePrevData)
 ...
 ''' Indice converter to add indice data.
 ''' </param>
 Public Sub CreatePolygonA(ByVal CircumRadius As Single, ByVal EdgeCount As Integer, _
                           ByVal ColourCenter As ColorValue, ByVal ColourRim As ColorValue, _
                  Optional ByVal AngleOffsetInDegrees As Single = 0, _
                  Optional ByVal AngleSizeInDegrees As Single = 360, _
                  Optional ByVal ReverseFaces As Boolean = False, _
  ...
  ' Create the mesh from standard template.
  M = MeshTemplates.CreatePolygon(CircumRadius, EdgeCount, ColourCenter, ColourRim, _
 ...
 ''' Indice converter to add indice data.
 ''' </param>
 Public Sub CreateSphere(ByVal Radius As Single, _
                Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
                Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing)
 ...
 Public Sub CreateSphere(ByVal Radius As Single, _
  ...
  ' Create the mesh from standard template.
  M = MeshTemplates.CreateSphere(Radius, ColourTop, ColourBottom, _
 ...
 ''' Indice converter to add indice data.
 ''' </param>
 Public Sub CreateBox(ByVal Size As Vector3, _
             Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
             Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing)
 ...
 ''' Indice converter to add indice data.
 ''' </param>
 Public Sub CreateBox(ByRef Size As Vector3, _
                      ByVal ColourTop As ColorValue, _
                      ByVal ColourBottom As ColorValue, _
  ...
  ' Create the mesh from standard template.
  M = MeshTemplates.CreateBox(Size, ColourTop, ColourBottom, _
 ...
 ''' Vertex Transformer.
 ''' </param>
 Public Sub CreatePrism(ByVal AxisLength As Single, ByVal EdgeLength As Single, _
                        ByVal NumRectSides As Integer, _
               Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
  ...
  ' Create a new prism.
  CreatePrism(AxisLength, EdgeLength, 4, NumRectSides, Col, Col, _
 ...
 Public Sub CreatePrism(ByVal AxisLength As Single, ByVal EdgeLength As Single, _
               ...
               Optional ByVal ReverseFaces As Boolean = False, _
               Optional ByVal RemovePrevData As Boolean = True, _
               Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
               Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing, _
               Optional ByVal _VT As Func(Of VertexType, Matrix, VertexType) = Nothing)
 ...
 ''' Vertex transformer.
 ''' </param>
 Public Sub CreatePrismA(ByVal AxisLength As Single, _
                         ByVal CircumRadiusFront As Single, ByVal CircumRadiusBack As Single, _
                         ByVal NumStacks As Integer, ByVal NumRectSides As Integer, _
                         ByVal ColourFront As ColorValue, ByVal ColourBack As ColorValue, _
                Optional ByVal AngleOffsetInDegrees As Single = 0, _
                Optional ByVal AngleSizeInDegrees As Single = 360, _
                Optional ByVal ClosedFront As Boolean = True, _
                Optional ByVal ClosedBack As Boolean = True, _
  ...
  ' Create the mesh from standard template.
  M = MeshTemplates.CreatePrism(AxisLength, CircumRadiusFront, CircumRadiusBack, _
                                NumStacks, NumRectSides, ColourFront, ColourBack, _
                                AngleOffsetInDegrees, AngleSizeInDegrees, _
                                ClosedFront, ClosedBack, ClosedShape, _
 ...
 ''' Vertex Transformer.
 ''' </param>
 Public Sub CreatePyramid(ByVal AxisLength As Single, ByVal EdgeLength As Single, _
                          ByVal NumRectSides As Integer, _
                 Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
                 Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing, _
                 Optional ByVal _VT As Func(Of VertexType, Matrix, VertexType) = Nothing)
  ...
  CreatePyramid(AxisLength, EdgeLength, 4, NumRectSides, Col, Col, _
                _VC:=_VC, _IC:=_IC, _VT:=_VT)
 ...
 ''' Vertex transformer.
 ''' </param>
 Public Sub CreateThreeColourCrosshair(Optional ByVal RemovePrevData As Boolean = True, _
                                       Optional ByVal _VC As Converter(Of Standard.Vertex, VertexType) = Nothing, _
                                       Optional ByVal _IC As Converter(Of Integer, IndiceType) = Nothing, _
                                       Optional ByVal _VT As Func(Of VertexType, Matrix, VertexType) = Nothing)
  ' Colours.
  Dim red As New Direct3D.ColorValue(255, 0, 0), _
      green As New Direct3D.ColorValue(0, 255, 0), _
  ...
  ' Create the X bar.
  CreatePrism(1, 0.1, 1, 4, red, red, ClosedFront:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
  m_Parts(m_Parts.Count - 1).Transform(Matrix.RotationZ(Math.PI / 4.0F) * Matrix.RotationY(Math.PI / 2.0F), _VT)

  ' Create the +X cap.
  CreatePyramid(0.2, 0.1, 1, 4, red, red, ClosedBack:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
  m_Parts(m_Parts.Count - 1).Transform(Matrix.Translation(0, 0, 0.6) * Matrix.RotationZ(Math.PI / 4.0F) * Matrix.RotationY(Math.PI / 2.0F), _VT)

  ' Create the Y bar.
  CreatePrism(1, 0.1, 1, 4, green, green, ClosedFront:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
  m_Parts(m_Parts.Count - 1).Transform(Matrix.RotationZ(Math.PI / 4.0F) * Matrix.RotationX(-Math.PI / 2.0F), _VT)

  ' Create the +Y cap.
  CreatePyramid(0.2, 0.1, 1, 4, green, green, ClosedBack:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
  m_Parts(m_Parts.Count - 1).Transform(Matrix.Translation(0, 0, 0.6) * Matrix.RotationZ(Math.PI / 4.0F) * Matrix.RotationX(-Math.PI / 2.0F), _VT)

  ' Create the Z bar.
  CreatePrism(1, 0.1, 1, 4, blue, blue, ClosedFront:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
  m_Parts(m_Parts.Count - 1).Transform(Matrix.RotationZ(Math.PI / 4.0F), _VT)

  ' Create the +Z cap
  CreatePyramid(0.2, 0.1, 1, 4, blue, blue, ClosedBack:=False, RemovePrevData:=False, _VC:=_VC, _IC:=_IC, _VT:=_VT)
