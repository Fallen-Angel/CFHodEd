...
Public NotInheritable Class MAD
 ...
 : Exit Sub
  ...
  If ChunkAttributes.ID = "NAME" Then _
   Trace.Assert(String.Compare(IFF.ReadString(ChunkAttributes.Size), MAD_Name) = 0, "NAME chunk ID test failed.") _
 : Exit Sub
 ...
 Private Sub ReadINFOChunk(ByVal IFF As IFF.IFFReader, ByVal ChunkAttributes As IFF.ChunkAttributes)
  Dim animationCount As Integer, _
      animationCurveCount As Integer, _
      jointMapCount As Integer, _
 ...
 Private Sub WriteINFOChunk(ByVal IFF As IFF.IFFWriter)
  Dim jointMapCount As Integer = 0, _
