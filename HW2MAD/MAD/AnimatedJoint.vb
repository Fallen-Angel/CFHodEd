...
Public Class AnimatedJoint
 ...
 Public Property KeyframeTime(ByVal Index As Integer) As Double
  ...
  : Exit Property
   ...
   m_TranslateX.Keyframes(Index) = New Keyframe With {.Time = value, .Value = m_TranslateX.Keyframes(Index).Value}
   m_TranslateY.Keyframes(Index) = New Keyframe With {.Time = value, .Value = m_TranslateY.Keyframes(Index).Value}
   m_TranslateZ.Keyframes(Index) = New Keyframe With {.Time = value, .Value = m_TranslateZ.Keyframes(Index).Value}
 ...
 Public Property KeyframePosition(ByVal index As Integer) As Vector3
  ...
  : Exit Property
   ...
   Return New Vector3(CSng(m_TranslateX.Keyframes(index).Value), _
                      CSng(m_TranslateY.Keyframes(index).Value), _
  ...
  : Exit Property
   ...
   m_TranslateX.Keyframes(index) = New Keyframe With {.Time = m_TranslateX.Keyframes(index).Time, .Value = value.X}
   m_TranslateY.Keyframes(index) = New Keyframe With {.Time = m_TranslateY.Keyframes(index).Time, .Value = value.Y}
   m_TranslateZ.Keyframes(index) = New Keyframe With {.Time = m_TranslateZ.Keyframes(index).Time, .Value = value.Z}
 ...
 Public Property KeyframeRotation(ByVal index As Integer) As Vector3
  ...
  : Exit Property
   ...
   Return New Vector3(CSng(m_RotateX.Keyframes(index).Value), _
                      CSng(m_RotateY.Keyframes(index).Value), _
 ...
 Friend Sub Update(ByVal time As Single)
  ...
  ' Set defaults.
  Dim position As Vector3 = m_DefaultPosition, _
      rotation As Vector3 = m_DefaultRotation, _
