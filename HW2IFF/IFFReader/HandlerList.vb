...
Friend Class HandlerList
 ...
 ''' combination.
 ''' </remarks>
 Public Sub [AddHandler](ByVal ID As String, ByVal Type As ChunkType, _
                         ByVal Handler As ChunkHandler, _
 ...
 ''' </returns>
 Public Function FindHandler(ByVal ID As String, ByVal Type As ChunkType, _
 ...
 Private Function __CompareHandlers(ByVal h1 As HandlerNode, ByVal h2 As HandlerNode) As Boolean
  If (h1.ID = h2.ID) AndAlso _
     (h1.Type = h2.Type) AndAlso _
 ...
 ''' </returns>
 Private Function __MakeHandlerNode(ByVal ID As String, ByVal Type As ChunkType, _
