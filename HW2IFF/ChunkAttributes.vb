...
Public Structure ChunkAttributes
 ...
 ''' Version of chunk.
 ''' </param>
 Friend Sub New(ByVal ID As String, ByVal Size As Integer, ByVal Type As ChunkType, Optional ByVal Version As UInteger = 0)
  ' Check inputs.
 ...
 : Exit Sub
  ...
  ' Check inputs.
  If (Type <> ChunkType.Default) AndAlso _
     (Type <> ChunkType.Normal) AndAlso _
