...
Public Class WavefrontObject
 ...
 Public Shared Sub ReadFile(Of VertexType As {Structure, IVertex}, _
                           ...
                           (ByVal Filename As String, _
                            ByVal OutMesh As GBasicMesh(Of VertexType, IndiceType, MaterialType), _
                   Optional ByVal ReverseUVs As Boolean = False)

  Dim ObjFile As New ObjFileDataStore, _
 ...
 Public Shared Sub WriteFile(Of VertexType As {Structure, IVertex}, _
                                ...
                                MaterialType As {Structure, IMaterial}) _
                            (ByVal Filename As String, _
                             ByVal Mesh As GBasicMesh(Of VertexType, IndiceType, MaterialType), _
                             Optional ByVal BreakIntoGroups As Boolean = True, _
                             Optional ByVal WriteUVs As Boolean = True, _
                             Optional ByVal WriteNormals As Boolean = True, _
                             Optional ByVal WriteColourData As Boolean = False, _
                             Optional ByVal ReverseUVs As Boolean = False)
 ...
 : F.WriteLine()
  ...
  For I As Integer = 0 To Mesh.PartCount - 1
   ...
   : If WriteUVs Then _
      F.WriteLine("vt " & _SngToStr(TC.X) & " " & _SngToStr(CSng(IIf(ReverseUVs, 1.0F - TC.Y, TC.Y))))
   ...
   : If WriteColourData Then _
      F.WriteLine("vc " & _SngToStr(CInt(255 * C.Red)) & " " & _SngToStr(CInt(255 * C.Green)) & " " & _
   ...
   For J As Integer = 0 To Mesh.Part(I).PrimitiveGroupCount - 1
    ...
    F.WriteLine("# " & CStr(P.IndiceCount) & " indices; " & _
