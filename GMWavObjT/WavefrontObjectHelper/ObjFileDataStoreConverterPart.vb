...
Namespace WavefrontObjectHelper
    ...
    Friend Class ObjFileDataStoreConverterPart
        ...
        Private Function GetVertexOrAdd(ByRef IndData As IndiceValues) As Integer
            ...
            If (IndData.Position < 0) OrElse (IndData.Position >= m_ObjData.P.Count) OrElse
               (IndData.Normal < 0) OrElse (IndData.Normal >= m_ObjData.N.Count) OrElse
               (IndData.UV < 0) OrElse (IndData.UV >= m_ObjData.UV.Count) OrElse
            ...
            If m_VertMap.ContainsKey(IndData) Then _
                ...
                VtxInd = m_Verts.Count _
                    ...
                    : m_Verts.Add(
                        New Standard.Vertex(
                            m_ObjData.P(IndData.Position),
                            m_ObjData.N(IndData.Normal),
                            m_ObjData.UV(IndData.UV),
                            m_ObjData.Col(IndData.Colour).ToArgb())
                        )
        ...
        Public Sub CopyTo (Of VertexType As {Structure, IVertex}, _
            ...
            (ByVal OutPart As GMeshPart(Of VertexType, IndiceType, MaterialType),
            ...
            For I As Integer = 0 To 2
                ...
                Select Case I
                    Case 0 : IndGroup = m_Ind1
                        IndGroupType = PrimitiveType.PointList
                    Case 1 : IndGroup = m_Ind2
                        IndGroupType = PrimitiveType.LineList
                    Case 2 : IndGroup = m_Ind3
                        IndGroupType = PrimitiveType.TriangleList
