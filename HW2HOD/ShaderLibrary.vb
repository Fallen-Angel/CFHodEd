...
Public NotInheritable Class ShaderLibrary
 ...
 Private Shared Function IsHLSL(ByVal shader As String, Optional ByRef profile As String = "") As Boolean
  ...
  For I As Integer = 0 To lines.Length - 1
   ...
   If (line = "vs_1_0") OrElse (line = "ps_1_0") OrElse (line = "vs_1_1") OrElse _
      (line = "ps_1_1") OrElse (line = "ps_1_2") OrElse (line = "ps_1_3") OrElse _
      (line = "ps_1_4") OrElse (line = "vs_2_0") OrElse (line = "ps_2_0") OrElse _
      (line = "vs_2_x") OrElse (line = "ps_2_x") OrElse (line = "vs_3_0") OrElse _
      (line = "ps_3_0") Then _
    Return False
 ...
 ''' Loads a shader.
 ''' </summary>
 Private Shared Function LoadShader(ByVal name As String, ByVal contents As String, ByVal Device As Direct3D.Device, ByVal override As Boolean) As Boolean
  ' Get the name.
 ...
 : Return False
  ...
  Try
   ...
   If IsHLSL(contents, profile) Then
    ...
    graphicsStream = Direct3D.ShaderLoader.CompileShader(contents, "main", Nothing, Nothing, profile, _
                                                         Direct3D.ShaderFlags.None, errString, Nothing)

   Else ' If IsHLSL(contents, profile) Then
    ' Try to assemble the shader.
    graphicsStream = Direct3D.ShaderLoader.FromString(contents, Nothing, Direct3D.ShaderFlags.None, errString)
 ...
 : Return False
  ...
  If Direct3D.ShaderLoader.GetShaderVersion(graphicsStream) > _
 ...
 ''' </param>
 Public Shared Function LoadShader(ByVal name As String, ByVal contents As String, ByVal Device As Direct3D.Device) As Boolean
