Partial Class Texture
    ...
    Private NotInheritable Class Mip
        ...
        ''' "DXT1", "DXT3" and "DXT5".
        ''' </param>
        Private Shared Function Size(ByVal Width As Integer, ByVal Height As Integer,
        ...
        Friend Sub ReadIFF(ByVal IFF As IFF.IFFReader, ByVal FourCC As String)
            ...
            If (FourCC <> "DXT1") AndAlso (FourCC <> "DXT3") AndAlso
            ...
            If FourCC = "8888" Then
                For I As Integer = 0 To m_Data.Length - 1 Step 4
                    ' RGBA
                    Dim A As Byte = m_Data(I),
                        B As Byte = m_Data(I + 1),
                        G As Byte = m_Data(I + 2),
        ...
        Friend Sub WriteIFF(ByVal IFF As IFF.IFFWriter, ByVal FourCC As String)
            ...
            Else ' If FourCC <> "8888" Then
                ...
                For I As Integer = 0 To data.Length - 1 Step 4
                    ' ARGB
                    Dim B As Byte = m_Data(I),
                        G As Byte = m_Data(I + 1),
                        R As Byte = m_Data(I + 2),
        ...
        ''' </exception>
        Friend Sub Read(ByVal BR As IO.BinaryReader, ByVal _Width As Integer, ByVal _Height As Integer,
                        ByVal FourCC As String)
            ' Uppercase the FourCC.
            FourCC.ToUpper()
