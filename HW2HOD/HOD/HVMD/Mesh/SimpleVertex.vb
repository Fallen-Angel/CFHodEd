...
Public Structure SimpleVertex
 ...
 Public ReadOnly Property Format() As Direct3D.VertexFormats Implements IVertex.Format
  Get
   Return Direct3D.VertexFormats.Position Or _
          Direct3D.VertexFormats.Normal Or _
 ...
 : Exit Function
  ...
  ' Compare.
  If (V.Position <> Position) OrElse _
     (V.Normal <> Normal) OrElse _
     (V.Tex <> Tex) OrElse _
     (V.PositionW <> PositionW) OrElse _
 ...
 ''' All index values point to the same set.
 ''' </remarks>
 Private Function SetTexCoords2(ByVal V As Vector2, Optional ByVal Index As Integer = 0) As IVertex Implements IVertexTex2.SetTexCoords2
  Tex = V
  Return Me
