...
Public NotInheritable Class VariableMesh
 ...
 Friend Sub ReadIFF(ByVal IFF As IFF.IFFReader, ByVal ChunkAttributes As IFF.ChunkAttributes)
  Dim VtxCount As Integer, _
      WedgeCount As Integer, _
      FaceCount As Integer, _
  ...
  If (VtxCount < 0) OrElse (WedgeCount < 0) OrElse (FaceCount < 0) OrElse _
 ...
 Public Function ToMultiMesh() As MultiMesh
  ...
  With BM
   ...
   : .Part(PartIndex).Material.VertexMask = VertexMasks.Position Or VertexMasks.Normal Or _
                                            VertexMasks.Texture0 Or VertexMasks.Texture1 Or _
