...
Public NotInheritable Class BasicMesh
                ...
                For J As Integer = 0 To .PrimitiveGroupCount - 1
                    Select Case .PrimitiveGroups(J).Type
                        Case Direct3D.PrimitiveType.TriangleList,
                            Direct3D.PrimitiveType.TriangleStrip,
        ...
        For I As Integer = 0 To PartCount - 1
            With Part(I)
                ...
                For J As Integer = 0 To .Vertices.Count - 1
                    ...
                    Dim UV As New Vector2(0.5F * CSng(Math.Atan2(P.Z, P.X) / Math.PI + 1),
                    ...
                    Dim X As Integer = CInt(Math.Floor(UV.X)),
                    ...
                    v.Diffuse = __blend(t1, t2, t3, t4, UV.X * UV.Y, UV.X * (1.0F - UV.Y), (1.0F - UV.X) * UV.Y,
                                        (1.0F - UV.X) * (1.0F - UV.Y))
                    .Vertices(J) = v
    ...
    ''' </summary>
    Private Shared Function __blend(ByVal A As Int32, ByVal B As Int32, ByVal C As Int32, ByVal D As Int32,
                                    ByVal xA As Single, ByVal xB As Single, ByVal xC As Single, ByVal xD As Single) _
        As Int32
        ...
        A2 = (A And &HFF00) >> 8
        A3 = (A And &HFF0000) >> 16
        A4 = (A And &HFF000000) >> 24
        B1 = B And &HFF
        B2 = (B And &HFF00) >> 8
        B3 = (B And &HFF0000) >> 16
        B4 = (B And &HFF000000) >> 24
        C1 = C And &HFF
        C2 = (C And &HFF00) >> 8
        C3 = (C And &HFF0000) >> 16
        C4 = (C And &HFF000000) >> 24
        D1 = D And &HFF
        D2 = (D And &HFF00) >> 8
        D3 = (D And &HFF0000) >> 16
        D4 = (D And &HFF000000) >> 24
    ...
    Private Shared Sub _CalcFaceTangents(ByRef Mesh As GMeshPart(Of BasicVertex, UShort, Material.Reference),
                                         ByRef tangent As Vector3, ByRef bitangent As Vector3, ByRef hand As Integer,
    ...
    Private Sub _UpdateVertTangents(ByRef Mesh As GMeshPart(Of BasicVertex, UShort, Material.Reference),
                                    ByRef altv() As Integer, ByRef handedness() As Integer, ByRef fT As Vector3,
    ...
    Private Shared Sub _NormaliseVertTangents(ByRef Mesh As GMeshPart(Of BasicVertex, UShort, Material.Reference),
        ...
        With Mesh.Vertices(I)
            ...
            If dp = 1 Or dp = -1 Then _
                Debug.Print("Vertex" & CStr(I) & ": Tangent generation failed, normal and tangent parallel.")
            temp = norm * dp
            temp = nTangent - temp
