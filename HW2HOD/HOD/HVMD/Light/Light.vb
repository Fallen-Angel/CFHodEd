...
Public NotInheritable Class Light
 ...
 Friend Sub WriteIFF(ByVal IFF As IFF.IFFWriter)
  If m_Type = LightType.Directional Then
   ...
   If m_Transform.LengthSq < 0.000001 Then _
    Trace.TraceError("Light '" & m_Name & "' has a direction vector of near zero (< 0.001) length. Please fix.") _
 ...
 Friend Sub Render(ByVal Device As Direct3D.Device, _
                   ByVal PointMesh As GenericMesh.Standard.BasicMesh, _
  ...
  PointMesh.Material(0) = New GenericMesh.Standard.Material With { _
   .Attributes = New Direct3D.Material With { _
    .EmissiveColor = New Direct3D.ColorValue(m_Colour.X, _
                                             m_Colour.Y, _
                                             m_Colour.Z) _
   } _
  }
  ...
  Select Case m_Type
   ...
   Case Light.LightType.Directional
    ...
    ' Set transform.
    Device.Transform.World = Matrix.Scaling(1.0F, 1.0F, 2.1F) * _
