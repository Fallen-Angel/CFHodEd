...
Partial Class Material
 ...
 Public Structure Reference
  ...
  Public Property VertexMask() As VertexMasks
   ...
   Set(ByVal value As VertexMasks)
    ...
    If ((value And VertexMasks.Texture2) <> 0) OrElse _
       ...
       ((value And VertexMasks.Texture7) <> 0) OrElse _
       ((value And VertexMasks.HVertex) <> 0) OrElse _
   ...
   : Exit Property
    ...
    If ((value And VertexMasks.Texture0) = 0) AndAlso _
  ...
  Private Sub Apply(ByVal _Device As Direct3D.Device) Implements GenericMesh.IMaterial.Apply
   Dim attrib As New Direct3D.Material With { _
    ...
    .EmissiveColor = New Direct3D.ColorValue(0.0F, 0.0F, 0.0F), _
    .SpecularSharpness = 96 _
   }
   ...
   Dim tex0 As Direct3D.Texture = Nothing, _
       tex1 As Direct3D.Texture = Nothing, _
       tex2 As Direct3D.Texture = Nothing, _
