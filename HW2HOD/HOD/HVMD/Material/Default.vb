...
Partial Class Material
    ...
    Public Structure [Default]
        ...
        ''' This does nothing.
        ''' </summary>
        Private Function Equal(ByVal other As GenericMesh.IMaterial) As Boolean _
            Implements System.IEquatable(Of GenericMesh.IMaterial).Equals
        ...
        ''' This does nothing.
        ''' </summary>
        Private Function SetMaterialName(ByVal V As String) As GenericMesh.IMaterial _
            Implements GenericMesh.MaterialFields.IMaterialName.SetMaterialName
            Return Me
        End Function
        ...
        Private Function GetTextureName(Optional ByVal Index As Integer = 0) As String _
            Implements GenericMesh.MaterialFields.IMaterialTexture.GetTextureName
            Return ""
        End Function
        ...
        ''' This does nothing.
        ''' </summary>
        Private Function SetTextureName(ByVal V As String, Optional ByVal Index As Integer = 0) As GenericMesh.IMaterial _
            Implements GenericMesh.MaterialFields.IMaterialTexture.SetTextureName
            Return Me
        End Function
    End Structure
End Class
