Partial Class HOD
 ...
 Private Sub Render_LoadShaderConstants(ByVal Device As Direct3D.Device, ByVal CameraPosition As Vector3)
  ...
  With Device
   ...
   .SetVertexShaderConstant(44, New Vector4(.RenderState.Ambient.R, .RenderState.Ambient.G, .RenderState.Ambient.B, .RenderState.Ambient.A))

   For I As Integer = 0 To 7
    .SetVertexShaderConstant(48 + 6 * I, New Vector4(.Lights(I).Position.X, .Lights(I).Position.Y, .Lights(I).Position.Z, 1.0F))
    .SetVertexShaderConstant(49 + 6 * I, New Vector4(.Lights(I).Direction.X, .Lights(I).Direction.Y, .Lights(I).Direction.Z, 1.0F))

    If .Lights(I).Enabled Then
     .SetVertexShaderConstant(50 + 6 * I, New Vector4(.Lights(I).AmbientColor.Red, .Lights(I).AmbientColor.Green, .Lights(I).AmbientColor.Blue, .Lights(I).AmbientColor.Alpha))
     .SetVertexShaderConstant(51 + 6 * I, New Vector4(.Lights(I).DiffuseColor.Red, .Lights(I).DiffuseColor.Green, .Lights(I).DiffuseColor.Blue, .Lights(I).DiffuseColor.Alpha))
     .SetVertexShaderConstant(52 + 6 * I, New Vector4(.Lights(I).SpecularColor.Red, .Lights(I).SpecularColor.Green, .Lights(I).SpecularColor.Blue, .Lights(I).SpecularColor.Alpha))
    ...
    .SetVertexShaderConstant(53 + 6 * I, New Vector4(.Lights(I).Attenuation0, .Lights(I).Attenuation1, .Lights(I).Attenuation2, 0.0F))
