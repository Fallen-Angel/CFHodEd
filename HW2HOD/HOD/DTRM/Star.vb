...
Public Structure Star
 ...
 Friend ReadOnly Property Format() As Microsoft.DirectX.Direct3D.VertexFormats Implements GenericMesh.IVertex.Format
  Get
   Return Direct3D.VertexFormats.Position Or _
          Direct3D.VertexFormats.PointSize Or _
 ...
 ''' </exception>
 Private Function Equal(ByVal other As GenericMesh.IVertex) As Boolean Implements System.IEquatable(Of GenericMesh.IVertex).Equals
 ...
 : Exit Function
  ...
  ' Compare.
  If (m_Position = obj.m_Position) AndAlso _
     (m_Size = obj.m_Size) AndAlso _
 ...
 ''' Modified vertex.
 ''' </returns>
 Private Function Transform(ByVal M As Microsoft.DirectX.Matrix) As GenericMesh.IVertex Implements GenericMesh.VertexFields.IVertexTransformable.Transform
 ...
 ''' </summary>
 Private Function GetPosition3() As Microsoft.DirectX.Vector3 Implements GenericMesh.VertexFields.IVertexPosition3.GetPosition3
  Return m_Position
 ...
 ''' The modified vertex.
 ''' </returns>
 Private Function SetPosition3(ByVal V As Microsoft.DirectX.Vector3) As GenericMesh.IVertex Implements GenericMesh.VertexFields.IVertexPosition3.SetPosition3
  m_Position = V
  Return Me
 ...
 ''' Modified vertex.
 ''' </returns>
 Private Function SetPointSize(ByVal V As Single) As GenericMesh.IVertex Implements GenericMesh.VertexFields.IVertexPointSize.SetPointSize
  m_Size = V
  Return Me
 ...
 ''' </summary>
 Private Function GetDiffuse() As Microsoft.DirectX.Direct3D.ColorValue Implements GenericMesh.VertexFields.IVertexDiffuse.GetDiffuse
  Return Direct3D.ColorValue.FromArgb(m_Diffuse)
 ...
 ''' The modified vertex.
 ''' </returns>
 Private Function SetDiffuse(ByVal V As Microsoft.DirectX.Direct3D.ColorValue) As GenericMesh.IVertex Implements GenericMesh.VertexFields.IVertexDiffuse.SetDiffuse
  m_Diffuse = V.ToArgb()
  m_Colour.X = V.Red
  m_Colour.Y = V.Green
  m_Colour.Z = V.Blue
