''' <summary>
''' Class representing a Homeworld2 star field.
''' </summary>
Public NotInheritable Class StarField
 ' --------------
 ' Class Members.
 ' --------------
 ...
 ''' Copy contructor.
 ''' </summary>
 Public Sub New(ByVal sf As StarField)
  Initialize()
 ...
 : Exit Sub
  ...
  Next I ' For I As Integer = m_Stars.Length - 2 To index Step -1
 ...
 Friend Sub ReadIFF(ByVal IFF As IFF.IFFReader)
  ...
  For I As Integer = 0 To numStars - 1
   m_Stars(I) = Star.ReadIFF(IFF, True)
 ...
 Friend Sub WriteIFF(ByVal IFF As IFF.IFFWriter)
  ...
  IFF.Push("STRF", Homeworld2.IFF.ChunkType.Normal, 1000)
  IFF.WriteInt32(m_Stars.Length)

  For I As Integer = 0 To m_Stars.Length - 1
   m_Stars(I).WriteIFF(IFF, True)
 ...
 Friend Sub Render(ByVal Device As Direct3D.Device, ByVal Transform As Matrix)
  ...
  With Device
   ' Cache some states.
   Dim oldAmbient As Drawing.Color = .RenderState.Ambient, _
       oldLighting As Boolean = .RenderState.Lighting, _
