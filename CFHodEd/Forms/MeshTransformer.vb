...
Friend NotInheritable Class MeshTransformer
    ...
    ''' </summary>
    Private Function AskVector3FromUser(ByRef Canceled As Boolean,
    ...
    Private Sub MeshTransformer_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) _
    ...
    Private Sub cmdTranslate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles cmdTranslate.Click
    ...
    Private Sub cmdResetCamera_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles cmdResetCamera.Click
