...
Friend NotInheritable Class MaterialSubstitute
    ...
    ''' Class constructor.
    ''' </summary>
    Public Sub New(ByVal PartIndex As Integer, ByVal BasicMesh As BasicMesh, ByVal HOD As HOD,
                   ByVal OldMaterialName As String)
    ...
    Private Sub cboMaterial_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) _
        Handles cboMaterial.SelectedIndexChanged
