...
Friend NotInheritable Class TexturePreview
 ...
 Private Sub m_D3DManager_Disposing(ByVal sender As Object, ByVal e As System.EventArgs) Handles m_D3DManager.Disposing
  ' Dispose the texture.
  m_Texture.Dispose()
 ...
 Private Sub m_D3DManager_Render() Handles m_D3DManager.Render
  Dim vtx() As Direct3D.CustomVertex.TransformedTextured = { _
   New Direct3D.CustomVertex.TransformedTextured(m_Offset.X, m_Offset.Y, 0, 1, 0, 0), _
   New Direct3D.CustomVertex.TransformedTextured(m_Offset.X + m_Size.X * m_Zoom, m_Offset.Y, 0, 1, 1, 0), _
   New Direct3D.CustomVertex.TransformedTextured(m_Offset.X, m_Offset.Y + m_Size.Y * m_Zoom, 0, 1, 0, 1), _
   New Direct3D.CustomVertex.TransformedTextured(m_Offset.X + m_Size.X * m_Zoom, m_Offset.Y + m_Size.Y * m_Zoom, 0, 1, 1, 1) _
  }
 ...
 Private Sub TexturePreview_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
  ' Stop rendering.
 ...
 Private Sub pbxDisplay_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pbxDisplay.MouseMove
  ...
  Dim newPos As New Vector2(e.X, e.Y), _
 ...
 Private Sub cmdZoom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdZoomIn.Click, cmdZoomOut.Click
