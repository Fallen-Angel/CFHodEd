Public NotInheritable Class LightEditor
    ...
    Private Sub txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles txtAmbientRed.TextChanged, txtAmbientGreen.TextChanged, txtAmbientBlue.TextChanged,
                txtDiffuseRed.TextChanged, txtDiffuseGreen.TextChanged, txtDiffuseBlue.TextChanged,
    ...
    Private Sub txt_Validated(ByVal sender As Object, ByVal e As System.EventArgs) _
        Handles txtAmbientRed.Validated, txtAmbientGreen.Validated, txtAmbientBlue.Validated,
                txtDiffuseRed.Validated, txtDiffuseGreen.Validated, txtDiffuseBlue.Validated,
    ...
    Private Sub txt_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) _
        Handles txtAmbientRed.Validating, txtAmbientGreen.Validating, txtAmbientBlue.Validating,
                txtDiffuseRed.Validating, txtDiffuseGreen.Validating, txtDiffuseBlue.Validating,
