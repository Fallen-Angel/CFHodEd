...
#Region " Menus and Toolbar "
 ...
 Private Sub mnuFileOpen_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuFileOpen.Click
  ...
  If OpenHODFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
 ...
 Private Sub mnuFileSaveAs_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnuFileSaveAs.Click
  ' See if user clicked cancel.
  If SaveHODFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
...
#Region " Picture Box UI "
  ...
  If Not pbxDisplay_IgnoreMouseMove Then
   Select Case e.Button
    ...
    Case Windows.Forms.MouseButtons.Middle, _
     ...
     m_Camera.CameraPan(m_CameraSensitivity * NewPos, _
                        m_CameraSensitivity * OldPos, _
                        Matrix.Identity)
 ...
 Private Sub pbxDisplay_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pbxDisplay.MouseUp
  ...
  If timePressed < pbxDisplay_RightClickThreshold Then
   ...
   If (e.Location.X + pbxDisplay_cms.Width > pbxDisplay.ClientSize.Width) AndAlso _
...
#Region " Misc. UI "
 ...
 Private Sub _UpdateTabs()
  With tspMode.Items
   ...
   Else ' If m_HOD.Version = 1000 Then
    ...
    If (m_HOD.Name = HOD.Name_SimpleMesh) OrElse _
 ...
 Handles txtMaterialColourR.Validating, txtMaterialColourG.Validating, txtMaterialColourB.Validating, txtMaterialColourA.Validating, _
         txtJointsPositionX.Validating, txtJointsPositionY.Validating, txtJointsPositionZ.Validating, _
         txtJointsRotationX.Validating, txtJointsRotationY.Validating, txtJointsRotationZ.Validating, _
         txtJointsAxisX.Validating, txtJointsAxisY.Validating, txtJointsAxisZ.Validating, _
         txtEngineBurn1X.Validating, txtEngineBurn1Y.Validating, txtEngineBurn1Z.Validating, _
         txtEngineBurn2X.Validating, txtEngineBurn2Y.Validating, txtEngineBurn2Z.Validating, _
         txtEngineBurn3X.Validating, txtEngineBurn3Y.Validating, txtEngineBurn3Z.Validating, _
         txtEngineBurn4X.Validating, txtEngineBurn4Y.Validating, txtEngineBurn4Z.Validating, _
         txtEngineBurn5X.Validating, txtEngineBurn5Y.Validating, txtEngineBurn5Z.Validating, _
         txtCMMinX.Validating, txtCMMinY.Validating, txtCMMinZ.Validating, _
         txtCMMaxX.Validating, txtCMMaxY.Validating, txtCMMaxZ.Validating, _
         txtCMCX.Validating, txtCMCY.Validating, txtCMCZ.Validating, _
         txtNavlightsColourR.Validating, txtNavlightsColourG.Validating, txtNavlightsColourB.Validating, _
         txtMarkerPositionX.Validating, txtMarkerPositionY.Validating, txtMarkerPositionZ.Validating, _
         txtMarkerRotationX.Validating, txtMarkerRotationY.Validating, txtMarkerRotationZ.Validating, _
         txtDockpathsKeyframePositionX.Validating, txtDockpathsKeyframePositionY.Validating, txtDockpathsKeyframePositionZ.Validating, _
         txtDockpathsKeyframeRotationX.Validating, txtDockpathsKeyframeRotationY.Validating, txtDockpathsKeyframeRotationZ.Validating, _
         txtLightTX.Validating, txtLightTY.Validating, txtLightTZ.Validating, _
         txtLightCR.Validating, txtLightCG.Validating, txtLightCB.Validating, _
         txtLightSR.Validating, txtLightSG.Validating, txtLightSB.Validating, _
         txtAnimationsJointsPX.Validating, txtAnimationsJointsPY.Validating, txtAnimationsJointsPZ.Validating, _
 ...
 Handles txtCMRadius.Validating, txtNavLightsSize.Validating, txtNavLightsPhase.Validating, _
         txtNavLightsFrequency.Validating, txtNavLightsDistance.Validating, txtDockpathsGlobalTolerance.Validating, _
         txtDockpathsKeyframeTolerance.Validating, txtDockpathsKeyframeMaxSpeed.Validating, _
         txtLightAttDist.Validating, txtAnimationsST.Validating, txtAnimationsET.Validating, _
...
#Region " Textures UI "
 ...
 Private Sub cmdTextureImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdTextureImport.Click
  ...
  If OpenTextureFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
 ...
 : SaveTextureFileDialog.DefaultExt = "dds"
  ...
  ' See if the user pressed cancel.
  If SaveTextureFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
 ...
 Private Sub cmdTexturesExportAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdTexturesExportAll.Click
  ' See if the user pressed cancel.
  If FolderBrowserDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
  ...
  : Continue For
   ...
   Dim filename As String = FolderBrowserDialog.SelectedPath & "\" & _
                            _GetTextureFilenameFromPath(m_HOD.Textures(I).Path) & _
                            ext
...
#Region " Materials UI "
 ...
 Private Sub cmdMaterialRename_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMaterialRename.Click
  ...
  : MsgBox("The name you entered is a duplicate!" & vbCrLf & _
 ...
 Private Sub lstMaterialParameters_Cut()
  ...
  ' Get it's index.
  Dim ind As Integer = lstMaterials.SelectedIndex, _
 ...
 Private Sub cmdMaterialParameterAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMaterialParameterAdd.Click
  ...
  : Continue Do
   ...
   m_HOD.Materials(lstMaterials.SelectedIndex).Parameters.Add(New Material.Parameter With { _
    .Name = name, _
 ...
 Private Sub cmdMaterialParametersFromFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMaterialParametersFromFile.Click
  ' See if the user pressed cancel.
  If OpenShaderFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
  ...
  Catch ex As Exception
   MsgBox("Error occured while trying to parse shader: " & vbCrLf & _
  ...
  m_HOD.Materials(lstMaterials.SelectedIndex).ShaderName = _
 ...
 Private Sub optMaterialParameterType_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optMaterialParameterTexture.CheckedChanged, optMaterialParameterColour.CheckedChanged
  ...
  With m_HOD.Materials(lstMaterials.SelectedIndex).Parameters(lstMaterialParameters.SelectedIndex)
   ...
   If .Type = Material.Parameter.ParameterType.Texture Then
    ...
    ' Check index.
    If (.TextureIndex < -1) OrElse _
       (.TextureIndex >= cboMaterialTextureIndex.Items.Count) Then _
     MsgBox("This material refers to a non-existant texture!" & vbCrLf & _
...
#Region " Ship Meshes UI "
  ...
  For I As Integer = 0 To basicMesh.PartCount - 1
   ...
   If (matIndex >= 0) AndAlso (matIndex < m_HOD.Materials.Count) Then
    ...
    For J As Integer = 0 To mat.Parameters.Count - 1
     If (String.Compare(mat.Parameters(J).Name, "$diffuse", True) = 0) OrElse _
 ...
 Private Sub lstShipMeshes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstShipMeshes.SelectedIndexChanged
  ...
  : MsgBox("The parent joint specified by this ship mesh does not exist!" & vbCrLf & _
 ...
 Private Sub cmdShipMeshesAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShipMeshesAdd.Click
  ...
  : Continue Do
   ...
   ' Since it's not a duplicate, add it.
   m_HOD.MultiMeshes.Add(New MultiMesh With { _
    .Name = name, _
    .ParentName = "Root" _
   })
 ...
 Private Sub cstShipMeshesLODs_Cut()
  ...
  ' Get it's index.
  Dim ind As Integer = lstShipMeshes.SelectedIndex, _
 ...
 Private Sub cmdShipMeshesLODImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShipMeshesLODImport.Click
  ' See if user pressed cancel.
  If OpenOBJFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
  ...
  If m IsNot Nothing Then
   ...
   _SetBasicMeshVertexMasks(m_HOD.MultiMeshes(lstShipMeshes.SelectedIndex).LOD(cstShipMeshesLODs.SelectedIndex), _
   ...
   For I As Integer = 0 To m.PartCount - 1
    Dim frm As New MaterialSubstitute(I, _
                                      m_HOD.MultiMeshes(lstShipMeshes.SelectedIndex).LOD(cstShipMeshesLODs.SelectedIndex), _
                                      m_HOD, _
                                      m.Material(I).Name)
 ...
 Private Sub cmdShipMeshesLODExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShipMeshesLODExport.Click
  ' See if user pressed cancel.
  If SaveOBJFileDialog.ShowDialog() = Windows.Forms.DialogResult.Cancel Then _
   Exit Sub
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.MultiMeshes(lstShipMeshes.SelectedIndex).LOD(cstShipMeshesLODs.SelectedIndex), _
    ReverseUVs:=reverseUVs _
   )
...
#Region " Goblins UI "
 ...
 Private Sub cstGoblins_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstGoblins.SelectedIndexChanged
  ...
  : MsgBox("The parent joint specified by this goblin mesh does not exist!" & vbCrLf & _
           "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Private Sub cmdGoblinsAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGoblinsAdd.Click
  ...
  : Continue Do
   ...
   Dim g As New GoblinMesh With { _
    .Name = name, _
    .ParentName = "Root" _
   }
 ...
 Private Sub cmdGoblinsImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGoblinsImport.Click
  ...
  If m IsNot Nothing Then
   ...
   _SetBasicMeshVertexMasks(m_HOD.GoblinMeshes(cstGoblins.SelectedIndex).Mesh, _
                            VertexMasks.Position Or VertexMasks.Normal Or VertexMasks.Texture0 Or VertexMasks.Texture1)
   ...
   For I As Integer = 0 To m.PartCount - 1
    Dim frm As New MaterialSubstitute(I, _
                                      m_HOD.GoblinMeshes(cstGoblins.SelectedIndex).Mesh, _
                                      m_HOD, _
                                      m.Material(I).Name)
...
#Region " UI Meshes UI "
     ...
     Select Case m.Part(0).PrimitiveGroups(I).Type
      Case Direct3D.PrimitiveType.TriangleList
       ...
       For J As Integer = 0 To m.Part(0).PrimitiveGroups(I).IndiceCount - 3 Step 3
        ' Get indices.
        Dim ind1 As Integer = m.Part(0).PrimitiveGroups(I).Indice(J), _
            ind2 As Integer = m.Part(0).PrimitiveGroups(I).Indice(J + 1), _
      ...
      Case Else
       ...
       Trace.TraceWarning(m.Part(0).PrimitiveGroups(I).Type.ToString() & _
 ...
 : cstUIMeshes.Items.Add("Wireframe Mesh " & CStr(m_HOD.SimpleMeshes.Count - 1), _
 ...
 Private Sub cstUIMeshesExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUIMeshesExport.Click
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.SimpleMeshes(cstUIMeshes.SelectedIndex) _
   )
...
#Region " Background Meshes UI "
 ...
 Private Sub cstBackgroundMeshes_Paste()
  ...
  cstBackgroundMeshes.Items.Add("Background Mesh " & CStr(m_HOD.BackgroundMeshes.Count), _
 ...
 Private Sub cmdBackgroundMeshesImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBackgroundMeshesImport.Click
  ...
  If m IsNot Nothing Then
   ...
   _SetBasicMeshVertexMasks(m_HOD.BackgroundMeshes(cstBackgroundMeshes.SelectedIndex), _
 ...
 Private Sub cmdBackgroundMeshesExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBackgroundMeshesExport.Click
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.BackgroundMeshes(cstBackgroundMeshes.SelectedIndex), _
 ...
 Private Sub cmdBackgroundMeshesRecolourize_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBackgroundMeshesRecolourize.Click
  ...
  ' Try to open texture...
  Try
   tex = Direct3D.TextureLoader.FromStream(m_D3DManager.Device, _
                                           stream, _
                                           0, 0, 1, _
                                           Direct3D.Usage.None, _
                                           Direct3D.Format.A8R8G8B8, _
                                           Direct3D.Pool.SystemMemory, _
                                           Direct3D.Filter.None, _
                                           Direct3D.Filter.None, _
                                           0)

  Catch ex As Direct3D.InvalidDataException
   MsgBox("The texture you provided seems to be invalid!", _
          MsgBoxStyle.Critical, Me.Text)

  Catch ex As Exception
   MsgBox("Error while trying to open texture: " & vbCrLf & _
          ex.ToString(), MsgBoxStyle.Critical, Me.Text)
 ...
 Private Sub cmdBackgroundMeshesRecolourizeAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBackgroundMeshesRecolourizeAll.Click
  ...
  If (w <= 1) OrElse (h <= 1) Then _
   MsgBox("The texture is too small. Please use a larger texture!", _
 ...
 Private Sub cmdBackgroundMeshesGenerateTexture_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdBackgroundMeshesGenerateTexture.Click
  ...
  ' Ask size multiplier.
  Do
   Dim str As String = InputBox("Enter size multiplier (0, 2]:" & vbCrLf & _
                                "(for example," & vbCrLf & _
                                " 0.5 gives an image of size 1024 x 512, " & vbCrLf & _
                                " 1.0 gives an image of size 2048 x 1024, " & vbCrLf & _
  ...
  : Continue Do
   ...
   If (sizeMultiplier <= 0) OrElse (sizeMultiplier > 2) Then _
    MsgBox("Size multiplier must be greater than zero" & vbCrLf & _
...
#Region " Joints UI "
 ...
 Private Sub cmdJointsAddTemplate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdJointsAddTemplate.Click
  ...
  If f.ShowDialog() = Windows.Forms.DialogResult.OK Then _
   tabJoints_Enter(Nothing, EventArgs.Empty)
 ...
 Handles txtJointsPositionX.TextChanged, txtJointsPositionY.TextChanged, txtJointsPositionZ.TextChanged, _
         txtJointsRotationX.TextChanged, txtJointsRotationY.TextChanged, txtJointsRotationZ.TextChanged, _
         txtJointsScaleX.TextChanged, txtJointsScaleY.TextChanged, txtJointsScaleZ.TextChanged, _
 ...
 Handles txtJointsPositionX.Validated, txtJointsPositionY.Validated, txtJointsPositionZ.Validated, _
         txtJointsRotationX.Validated, txtJointsRotationY.Validated, txtJointsRotationZ.Validated, _
         txtJointsScaleX.Validated, txtJointsScaleY.Validated, txtJointsScaleZ.Validated, _
...
#Region " Collision Mesh UI "
 ...
 Private Sub cstCM_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstCM.SelectedIndexChanged
  ...
  : MsgBox("The joint specified by this collision mesh does not exist!" & vbCrLf & _
           "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Private Sub cmdCMExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCMExport.Click
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.CollisionMeshes(cstCM.SelectedIndex), _
    False, False _
   )
 ...
 Handles txtCMMinX.TextChanged, txtCMMinY.TextChanged, txtCMMinZ.TextChanged, _
         txtCMMaxX.TextChanged, txtCMMaxY.TextChanged, txtCMMaxZ.TextChanged, _
         txtCMCX.TextChanged, txtCMCY.TextChanged, txtCMCZ.TextChanged, _
 ...
 Handles txtCMMinX.Validated, txtCMMinY.Validated, txtCMMinZ.Validated, _
         txtCMMaxX.Validated, txtCMMaxY.Validated, txtCMMaxZ.Validated, _
         txtCMCX.Validated, txtCMCY.Validated, txtCMCZ.Validated, _
...
#Region " Engine Shapes UI "
 ...
 Private Sub _PrepareEngineShapeAfterImport(ByVal es As EngineShape)
  ...
  For I As Integer = es.Part(0).PrimitiveGroupCount - 1 To 0 Step -1
   If (es.Part(0).PrimitiveGroups(I).Type <> Direct3D.PrimitiveType.TriangleList) AndAlso _
 ...
 Private Sub cstEngineShapes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstEngineShapes.SelectedIndexChanged
  ...
  : MsgBox("The parent joint specified by this engine shape does not exist!" & vbCrLf & _
           "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Private Sub cmdEngineShapesAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineShapesAdd.Click
  ...
  : Continue Do
   ...
   Dim es As New EngineShape With { _
    .Name = name, _
    .ParentName = "Root" _
   }
 ...
 Private Sub cmdEngineShapesExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineShapesExport.Click
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.EngineShapes(cstEngineShapes.SelectedIndex), _
    False, False _
   )
...
#Region " Engine Glows UI "
 ...
 Private Sub cstEngineGlows_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstEngineGlows.SelectedIndexChanged
  ...
  : MsgBox("The parent joint specified by this engine glow does not exist!" & vbCrLf & _
           "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Private Sub cmdEngineGlowsAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineGlowsAdd.Click
  ...
  : Continue Do
   ...
   ' Since it's not a duplicate, make a new mesh.
   Dim g As New EngineGlow With { _
    .Name = name, _
    .ParentName = "Root" _
   }
 ...
 Private Sub cmdEngineGlowsImport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineGlowsImport.Click
  ...
  If m IsNot Nothing Then
   ...
   _SetBasicMeshVertexMasks(m_HOD.EngineGlows(cstEngineGlows.SelectedIndex).Mesh, _
 ...
 Private Sub cmdEngineGlowsExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineGlowsExport.Click
  ...
  Try
   GenericMesh.Translators.WavefrontObject.WriteFile( _
    SaveOBJFileDialog.FileName, _
    m_HOD.EngineGlows(cstEngineGlows.SelectedIndex).Mesh, _
    ReverseUVs:=reverseUVs _
   )
...
#Region " Engine Burns UI "
  ...
  Else ' If cstEngineBurns.SelectedIndex = -1 Then
   ...
   With m_HOD.EngineBurns(cstEngineBurns.SelectedIndex)
    ...
    If Not _ComboBoxHasString(cboEngineBurnsParent.Items, .ParentName) Then _
     .ParentName = "Root" _
   : MsgBox("The parent joint specified by this engine burn does not exist!" & vbCrLf & _
            "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Private Sub cmdEngineBurnsAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEngineBurnsAdd.Click
  ...
  : Continue Do
   ...
   Dim g As New EngineBurn With { _
    .Name = name, _
    .ParentName = "Root" _
   }
 ...
 Handles txtEngineBurn1X.TextChanged, txtEngineBurn1Y.TextChanged, txtEngineBurn1Z.TextChanged, _
         txtEngineBurn2X.TextChanged, txtEngineBurn2Y.TextChanged, txtEngineBurn2Z.TextChanged, _
         txtEngineBurn3X.TextChanged, txtEngineBurn3Y.TextChanged, txtEngineBurn3Z.TextChanged, _
         txtEngineBurn4X.TextChanged, txtEngineBurn4Y.TextChanged, txtEngineBurn4Z.TextChanged, _
 ...
 Handles txtEngineBurn1X.Validated, txtEngineBurn1Y.Validated, txtEngineBurn1Z.Validated, _
         txtEngineBurn2X.Validated, txtEngineBurn2Y.Validated, txtEngineBurn2Z.Validated, _
         txtEngineBurn3X.Validated, txtEngineBurn3Y.Validated, txtEngineBurn3Z.Validated, _
         txtEngineBurn4X.Validated, txtEngineBurn4Y.Validated, txtEngineBurn4Z.Validated, _
...
#Region " NavLights UI "
 ...
 ''' </summary>
 Private Sub _NavLightFillImage(ByVal image As Image, Optional ByVal r As Single = 0, Optional ByVal g As Single = 0, _
 ...
 Private Sub tabNavLights_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles tabNavLights.Enter
  ...
  If pbxNavLightsSample.Image Is Nothing Then _
   pbxNavLightsSample.Image = New Bitmap(pbxNavLightsSample.ClientSize.Width, _
                                         pbxNavLightsSample.ClientSize.Height, _
  ...
  Else ' If cstNavLights.SelectedIndex = -1 Then
   ...
   With m_HOD.NavLights(cstNavLights.SelectedIndex)
    ...
    If Not _ComboBoxHasString(cboNavLightsName.Items, .Name) Then _
     .Name = "Root" _
   : MsgBox("The joint specified by this navlight does not exist!" & vbCrLf & _
            "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Handles txtNavLightsSection.TextChanged, txtNavLightsSize.TextChanged, txtNavLightsPhase.TextChanged, txtNavLightsFrequency.TextChanged, _
         txtNavLightsStyle.TextChanged, txtNavLightsDistance.TextChanged, txtNavlightsColourR.TextChanged, txtNavlightsColourG.TextChanged, _
 ...
 Handles txtNavLightsSection.Validated, txtNavLightsSize.Validated, txtNavLightsPhase.Validated, txtNavLightsFrequency.Validated, _
         txtNavLightsStyle.Validated, txtNavLightsDistance.Validated, txtNavlightsColourR.Validated, txtNavlightsColourG.Validated, _
...
#Region " Markers UI "
 ...
 Private Sub cstMarkers_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstMarkers.SelectedIndexChanged
  ...
  : MsgBox("The parent joint specified by this marker does not exist!" & vbCrLf & _
           "It has been changed to 'Root'.", MsgBoxStyle.Information, Me.Text)
 ...
 Handles txtMarkerPositionX.TextChanged, txtMarkerPositionY.TextChanged, txtMarkerPositionZ.TextChanged, _
 ...
 Handles txtMarkerPositionX.Validated, txtMarkerPositionY.Validated, txtMarkerPositionZ.Validated, _
...
#Region " Dockpaths UI "
 ...
 Handles txtDockpathsParentName.Validated, txtDockpathsGlobalTolerance.Validated, _
 ...
 Handles txtDockpathsKeyframePositionX.TextChanged, txtDockpathsKeyframePositionY.TextChanged, txtDockpathsKeyframePositionZ.TextChanged, _
         txtDockpathsKeyframeRotationX.TextChanged, txtDockpathsKeyframeRotationY.TextChanged, txtDockpathsKeyframeRotationZ.TextChanged, _
 ...
 Handles txtDockpathsKeyframePositionX.Validated, txtDockpathsKeyframePositionY.Validated, txtDockpathsKeyframePositionZ.Validated, _
         txtDockpathsKeyframeRotationX.Validated, txtDockpathsKeyframeRotationY.Validated, txtDockpathsKeyframeRotationZ.Validated, _
 ...
 Handles chkDockpathsKeyframeUseRotation.CheckedChanged, chkDockpathsKeyframeDropFocus.CheckedChanged, _
         chkDockpathsKeyframeCheckRotation.CheckedChanged, chkDockpathsKeyframeForceCloseBehaviour.CheckedChanged, _
         chkDockpathsKeyframePlayerInControl.CheckedChanged, chkDockpathsKeyframeQueueOrigin.CheckedChanged, _
...
#Region " Level Lights UI "
  ...
  Else ' If cstLights.SelectedIndex = -1 Then
   With m_HOD.Lights(cstLights.SelectedIndex)
    ...
    Catch ex As Exception
     ...
     ' Inform user.
     MsgBox("Error while setting type\attenuation." & vbCrLf & _
 ...
 Handles txtLightTX.TextChanged, txtLightTY.TextChanged, txtLightTZ.TextChanged, _
         txtLightCR.TextChanged, txtLightCG.TextChanged, txtLightCB.TextChanged, _
         txtLightSR.TextChanged, txtLightSG.TextChanged, txtLightSB.TextChanged, _
 ...
 Handles txtLightTX.Validated, txtLightTY.Validated, txtLightTZ.Validated, _
         txtLightCR.Validated, txtLightCG.Validated, txtLightCB.Validated, _
         txtLightSR.Validated, txtLightSG.Validated, txtLightSB.Validated, _
...
#Region " Star Fields UI "
 ...
 : Return False
  ...
  ' Get size.
  Dim w As Integer = T.GetLevelDescription(0).Width, _
  ...
  For Y As Integer = 0 To h - 1
   For X As Integer = 0 To w - 1
    ...
    ' Get angles.
    Dim theta As Single = CSng(Math.PI * (1 - 2 * X / (w - 1))), _
        phi As Single = CSng(Math.PI * (0.5 - Y / (h - 1)))

    ' Get position.
    Dim P As New Vector3(CSng(Math.Cos(theta) * Math.Cos(phi)), _
                         CSng(Math.Sin(phi)), _
 ...
 ''' </summary>
 Private Sub _UnprojectedBackgroundBounds(ByVal min As List(Of Vector2), ByVal min3D As List(Of Vector3), _
                                          ByVal max As List(Of Vector2), ByVal max3D As List(Of Vector3), _
  ...
  For I As Integer = 0 To m_HOD.BackgroundMeshes.Count - 1
   ...
   For J As Integer = 0 To m.Part(0).Vertices.Count - 1
    ...
    ' Unproject.
    Dim V As New Vector2(0.5F * CSng(1 - Math.Atan2(P.Z, P.X) / Math.PI), _
 ...
 ''' </summary>
 Private Function _ClassifyStar(ByVal P As Vector3, _
                                ByVal min As List(Of Vector2), ByVal min3D As List(Of Vector3), _
                                ByVal max As List(Of Vector2), ByVal max3D As List(Of Vector3), _
  ...
  For I As Integer = 0 To min.Count - 1
   ...
   If (min3D(I).X >= P.X) OrElse (min3D(I).Y >= P.Y) OrElse (min3D(I).Z >= P.Z) OrElse _
      (P.X >= max3D(I).X) OrElse (P.Y >= max3D(I).Y) OrElse (P.Z >= max3D(I).Z) Then _
    Continue For

   If (min(I).X <= V.X) AndAlso (min(I).Y <= V.Y) AndAlso _
 ...
 Private Function _MakeStarFieldTexture(ByVal stars As List(Of Star)) As Boolean
  ...
  ' Create new texture.
  Dim T As New Direct3D.Texture(m_D3DManager.Device, w, h, 1, Direct3D.Usage.None, _
 ...
 Private Sub cstStarFields_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cstStarFields.SelectedIndexChanged
  ...
  If enable Then
   ...
   For I As Integer = 0 To m_HOD.StarFields(cstStarFields.SelectedIndex).Count - 1
    ...
    ' Set data.
    rows(I).SetValues(New Object() {s.Position.X, s.Position.Y, s.Position.Z, s.Size, _
 ...
 Private Sub cmdStarfieldsAddStar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStarFieldsAddStar.Click
  ...
  ' Set data.
  r.SetValues(New Object() {s.Position.X, s.Position.Y, s.Position.Z, s.Size, _
                            s.Colour.Red, s.Colour.Green, s.Colour.Blue})
...
#Region " Animations UI "
 ...
 Private Sub _PlayAnimation(ByVal a As Animation)
  ...
  ' Update text.
  cmdAnimationsPlay.Invoke(CType(AddressOf __Rename, Action(Of Control, String)), _
 ...
 Handles txtAnimationsST.TextChanged, txtAnimationsET.TextChanged, _
 ...
 Handles txtAnimationsST.Validated, txtAnimationsET.Validated, _
 ...
 Private Sub lstAnimationsJoints_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstAnimationsJoints.SelectedIndexChanged
  ...
  Dim enable As Boolean = (lstAnimationsJoints.SelectedIndex <> -1) AndAlso _
