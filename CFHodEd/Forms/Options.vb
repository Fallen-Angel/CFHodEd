...
Friend NotInheritable Class Options
    ...
    Private Sub Options_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) _
    ...
    Private Sub Options_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' Create new bitmas.
        m_TeamColourBitmap = New Drawing.Bitmap(pbxTeamColour.Width, pbxTeamColour.Height,
                                                Imaging.PixelFormat.Format24bppRgb)
        m_StripeColourBitmap = New Drawing.Bitmap(pbxStripeColour.Width, pbxStripeColour.Height,
                                                  Imaging.PixelFormat.Format24bppRgb)
    ...
    Private Sub pbxTeamStripeColour_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles pbxTeamColour.Click, pbxStripeColour.Click
    ...
    Private Sub sldTeamStripe_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles sldTeamRed.Scroll, sldTeamGreen.Scroll, sldTeamBlue.Scroll, sldStripeRed.Scroll, sldStripeGreen.Scroll,
                sldStripeBlue.Scroll
    ...
    Private Sub cmdTeamStripeChoose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles cmdTeamChoose.Click, cmdStripeChoose.Click
    ...
    Private Sub cmdBadgeTextureBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles cmdBadgeTextureBrowse.Click
        ' See if user pressed cancel.
    ...
    Private Sub cmdBadgeNoTexture_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        Handles cmdBadgeNoTexture.Click
        ' Set badge texture.
        m_HOD.Badge = ""
    ...
    Private Sub ctlNextTime_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        If control.Tag Is Nothing Then _
            MsgBox("This setting will fully take effect the next time you start" & vbCrLf &
    ...
    Private Sub cmdResetAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdResetAll.Click
        ...
        If MsgBox("This will reset all settings, including window positions and" & vbCrLf &
                  "sizes and close this window without saving changes. Continue?",
