...
Public Module Utility
    ...
    Friend Function FormatIsRGB(ByVal f As Format) As Boolean
        Select Case f
            Case Format.R3G3B2,
                Format.A8R3G3B2, Format.A1R5G5B5, Format.X1R5G5B5, Format.A4R4G4B4, Format.X4R4G4B4, Format.R5G6B5,
                Format.R8G8B8,
                Format.A8R8G8B8, Format.A8B8G8R8, Format.X8R8G8B8, Format.X8B8G8R8, Format.R8G8B8G8, Format.G8R8G8B8,
                Format.A2R10G10B10, Format.A2B10G10R10,
                Format.A16B16G16R16, Format.A16B16G16R16F,
    ...
    Friend Function FormatBitCount(ByVal f As Format) As Integer
        Select Case f
            ...
            Case Format.R8G8B8
                ...
                ' 32-BIT FORMAT
            Case Format.A8R8G8B8, Format.A8B8G8R8, Format.X8R8G8B8, Format.X8B8G8R8, Format.R8G8B8G8, Format.G8R8G8B8,
                Format.A2R10G10B10, Format.A2B10G10R10
                Return 32
    ...
    Friend Function FormatHasAlpha(ByVal f As Format) As Boolean
        Select Case f
            ' ALPHA PRESENT
            Case Format.A8R3G3B2, Format.A1R5G5B5, Format.A4R4G4B4,
                Format.A8R8G8B8, Format.A8B8G8R8, Format.A2R10G10B10, Format.A2B10G10R10,
                Format.A16B16G16R16, Format.A16B16G16R16F,
                Format.A32B32G32R32F
                Return True
    ...
    Friend Function FormatRedBitCount(ByVal f As Format) As Integer
        Select Case f
            ...
            Case Format.A1R5G5B5, Format.X1R5G5B5, Format.R5G6B5
                ...
                ' 8-BIT RED CHANNEL
            Case Format.R8G8B8, Format.A8R8G8B8, Format.A8B8G8R8, Format.X8R8G8B8, Format.X8B8G8R8, Format.R8G8B8G8,
                Format.G8R8G8B8
                Return 8
    ...
    Friend Function FormatsAreEquivalent(ByVal f1 As Format, ByVal f2 As Format) As Boolean
        ...
        If (FormatAlphaBitCount(f1) = FormatAlphaBitCount(f2)) AndAlso
           (FormatGreenBitCount(f1) = FormatGreenBitCount(f2)) AndAlso
           (FormatRedBitCount(f1) = FormatRedBitCount(f2)) AndAlso
    ...
    Friend Function FormatIsDepthStencil(ByVal f As Format) As Boolean
        Select Case f
            Case Format.D15S1, Format.D16, Format.D16Lockable,
                Format.D24X8, Format.D24X4S4, Format.D24S8, Format.D24SingleS8,
    ...
    Friend Function FormatIsDepthLockable(ByVal f As Format) As Boolean
        If (f = Format.D16Lockable) OrElse
