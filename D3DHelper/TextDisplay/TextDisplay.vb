...
Namespace TextDisplay
    ...
    Public Class TextDisplay
        ...
        Public Sub New(ByVal Device As Direct3D.Device,
            ...
            m_Format = Direct3D.DrawTextFormat.Top Or
        ...
        ''' Font style.
        ''' </param>
        Public Sub SetAttributes(ByVal FontName As String, ByVal FontSize As Single,
        ...
        ''' The text to draw.
        ''' </param>
        Public Overridable Function DrawText(ByVal Text As String, Optional ByVal Sprite As Direct3D.Sprite = Nothing) _
            As Integer
