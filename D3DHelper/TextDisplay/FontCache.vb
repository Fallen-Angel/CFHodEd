...
Namespace TextDisplay
    ...
    Friend Structure FontCache
        ...
        ''' </param>
        Public Function RegisterFont(ByVal FontName As String, ByVal FontSize As Single,
            ...
            SysFont = m_SystemFonts.Find(
                Function(V As Drawing.Font) (
                                            (V.Name = FontName) AndAlso
                                            (V.SizeInPoints = FontSize) AndAlso
                                            (V.Style = FontStyle)
                                            )
                )

            ' Try to locate the element.
            Element = m_Elements.Find(
                Function(V As FontCacheElement) (
                                         (V.Name = FontName) AndAlso
                                         (V.Size = FontSize) AndAlso
                                         (V.Style = FontStyle) AndAlso
                                         (V.Device Is Device)
                                         )
                )
