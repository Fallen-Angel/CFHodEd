...
Friend NotInheritable Class DisplayTest
 ...
 Private Sub DisplayTest_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
 ...
 Private Sub DisplayTest_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
  ' Exit on escape.
 ...
 Private Sub m_D3DM_DeviceCreated(ByVal DeviceCreationFlags As Utility.DeviceCreationFlags) Handles m_D3DM.DeviceCreated
  Dim Mat As Material
  ...
  m_Mesh.OptimizeInPlace(MeshFlags.OptimizeAttributeSort Or _
                         MeshFlags.OptimizeCompact Or _
 ...
 Private Sub m_D3DM_Render() Handles m_D3DM.Render
  With m_D3DM.Device
   ...
   .Transform.World = Matrix.RotationX(CSng(Microsoft.VisualBasic.Timer / 2)) * _
                      Matrix.RotationY(CSng(Microsoft.VisualBasic.Timer / 1.5)) * _
