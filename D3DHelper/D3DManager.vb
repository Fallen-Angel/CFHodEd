...
Public NotInheritable Class D3DManager
 ...
 ''' </exception> 
 Public Sub CreateDevice(ByVal DeviceWindow As Control, _
                Optional ByVal ApplicationName As String = "", _
                Optional ByVal LoadSettingsFromRegistry As Boolean = True, _
 ...
 : Exit Sub
  ...
  If (LoadSettingsFromRegistry) AndAlso _
  ...
  ' Create the device.
  m_Device = New Device(m_CP.Adapter, _
                        m_CP.DeviceType, _
                        m_PP.DeviceWindow, _
                        m_CP.CreateFlags, _
                        m_PP)
 ...
 : SavePresentationParameters(ApplicationName, m_PP)
  ...
  With m_PP
   ...
   DCF.DepthBuffer = ((.EnableAutoDepthStencil) AndAlso _
                      (FormatDepthBitCount(.AutoDepthStencilFormat) > 0))

   DCF.StencilBuffer = ((.EnableAutoDepthStencil) AndAlso _
 ...
 ''' be determined then registry read\write is not done.
 ''' </remarks>
 Public Sub CreateDevice(ByVal DeviceWindowHandle As IntPtr, _
                Optional ByVal ApplicationName As String = "", _
                Optional ByVal LoadSettingsFromRegistry As Boolean = True, _
                Optional ByVal SaveSettingsToRegistry As Boolean = True)
  Dim ctl As Control
   ...
   Select Case ex.GetType.Name
    ...
    Case GetType(DeviceNotResetException).Name
     ...
     Try
      ' Reset.
      m_Window.Invoke( _
       CType(AddressOf m_Device.Reset, Action(Of PresentParameters)), _
       New Object() {m_PP} _
      )
 ...
 Private Sub RenderLoop(Optional ByVal DoEvents As Boolean = True)
  ...
  Do While (m_Rendering) AndAlso (m_Device IsNot Nothing)
   ...
   Catch ex As DriverInternalErrorException
    ...
    ' Warning message.
    Trace.Assert(False, "Warning: Encountered " & _
 ...
 : Exit Sub
  ...
  With m_PP
   ...
   If PP.Windowed Then _
    .FullScreenRefreshRateInHz = GetMaxRefreshRate(m_CP.Adapter, _
                                                  .BackBufferWidth, _
                                                  .BackBufferHeight, _
 ...
 : Exit Sub
  ...
  ' Check argument.
  If (NumTextureStages < 0) OrElse _
 ...
 ''' This is a device generated event.
 ''' </remarks>
 Private Sub m_Device_DeviceResizing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles m_Device.DeviceResizing
