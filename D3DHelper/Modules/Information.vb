...
Friend Module Information
 ...
 ''' </remarks>
 Public Function TryCreateDevice(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, ByVal _PresentParameters As PresentParameters) As Exception
  Dim D As Device = Nothing, _
      f As DeviceTest = Nothing, _
 ...
 ''' No validation is performed. This may modify the presentation paramters.
 ''' </remarks>
 Public Function TryCreateDeviceA(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, ByVal _CreateFlags As CreateFlags, ByVal _PresentParameters As PresentParameters) As Boolean
 ...
 ''' is not supported.
 ''' </exception>
 Public Function GetMaxRefreshRate(ByVal Adapter As Integer, ByVal Width As Integer, ByVal Height As Integer, ByVal _Format As Format) As Integer
 ...
 ''' to frequently.
 ''' </remarks>
 Public Function GetMaxBackBufferCount(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                       ...
                                       ByVal _MultiSampleType As MultiSampleType, ByVal Windowed As Boolean) As Integer
 ...
 Public Function GetMaxBackBufferCount(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                       ...
                                       ByVal _MultiSampleType As MultiSampleType, ByVal Windowed As Boolean) As Integer
  ' Call the other function.
  Return GetMaxBackBufferCount(Adapter, _DeviceType, _
 ...
 : Exit Function
  ...
  : Exit Function
   ...
   If (TypeOf ex Is OutOfMemoryException) OrElse _
