...
Friend Module Capability
 ...
 ''' </exception>
 Public Function CheckDeviceType(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
 ...
 : Exit Function
  ...
  Select Case Windowed
   ...
   Case Else
    If Manager.CheckDeviceType(Adapter, _DeviceType, DispMode.Format, DispMode.Format, False) OrElse _
 ...
 ''' </remarks>
 Public Function CheckDisplayFormat(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                    ByVal DisplayFormat As Format, ByVal BackBufferFormat As Format, _
 ...
 : Exit Function
  ...
  If Manager.CheckDeviceType(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, Windowed) AndAlso _
     Manager.CheckDeviceFormat(Adapter, _DeviceType, DisplayFormat, Usage.RenderTarget, ResourceType.Surface, BackBufferFormat) Then _
   Return True
 ...
 ''' display format of the given adapter is used.
 ''' </remarks>
 Public Function CheckDepthStencilFormat(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                         ByVal DisplayFormat As Format, ByVal BackBufferFormat As Format, _
                                         ByVal DepthStencilFormat As DepthFormat, ByVal Windowed As Boolean) As Boolean
  ' Check inputs.
 ...
 : Exit Function
  ...
  If Not CheckDisplayFormat(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, Windowed) Then _
   Throw New Exception("'CheckDisplayFormat' failed for given combination; " & _
 ...
 : Exit Function
  ...
  If Manager.CheckDeviceFormat(Adapter, _DeviceType, DisplayFormat, Usage.DepthStencil, ResourceType.Surface, DepthStencilFormat) AndAlso _
     Manager.CheckDepthStencilMatch(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, DepthStencilFormat) Then _
   Return True
 ...
 Public Function CheckDepthStencilFormat(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
  ...
  Return CheckDepthStencilFormat(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, _
 ...
 ''' display format of the given adapter is used.
 ''' </remarks>
 Public Function CheckMultiSampleType(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                      ByVal DisplayFormat As Format, ByVal BackBufferFormat As Format, _
                                      ByVal DepthStencilFormat As Format, ByVal _MultiSampleType As MultiSampleType, _
                                      ByVal Windowed As Boolean) As Boolean
  ' Check inputs.
 ...
 : Exit Function
  ...
  If Not CheckDepthStencilFormat(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, _
                                 DepthStencilFormat, Windowed) Then _
   Throw New ArgumentException("'CheckDepthStencilFormat' failed for given combination; " & _
                               "device creation will fail.") _
 : Exit Function
  ...
  If Manager.CheckDeviceMultiSampleType(Adapter, _DeviceType, BackBufferFormat, Windowed, _MultiSampleType) AndAlso _
     Manager.CheckDeviceMultiSampleType(Adapter, _DeviceType, DepthStencilFormat, Windowed, _MultiSampleType) Then _
   Return True
 ...
 Public Function CheckMultiSampleType(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                      ByVal DisplayFormat As Format, ByVal BackBufferFormat As Format, _
                                      ByVal DepthStencilFormat As DepthFormat, ByVal _MultiSampleType As MultiSampleType, _
                                      ByVal Windowed As Boolean) As Boolean
  ' Call the other function.
  Return CheckMultiSampleType(Adapter, _DeviceType, DisplayFormat, _
                              BackBufferFormat, CType(DepthStencilFormat, Format), _
 ...
 : Exit Function
  ...
  If Not CheckMultiSampleType(Adapter, _DeviceType, DisplayFormat, BackBufferFormat, _
  ...
  Result = Manager.CheckDeviceMultiSampleType(Adapter, _DeviceType, BackBufferFormat, _
                                              Windowed, _MultiSampleType, HResult, _
                                              QualityLevels)
  ...
  Result = Manager.CheckDeviceMultiSampleType(Adapter, _DeviceType, DepthStencilFormat, _
                                              Windowed, _MultiSampleType, HResult, _
                                              QualityLevels)
 ...
 ''' </remarks>
 Public Function CheckPresentationInterval(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
 ...
 : Exit Function
  ...
  ' Check if supported.
  If ((Manager.GetDeviceCaps(Adapter, _DeviceType).PresentationIntervals And _PresentInterval) = _PresentInterval) Then _
   Return True _
  Else _
   Return False
 ...
 Public Function CheckDisplayMode(ByVal Adapter As Integer, ByVal _DisplayMode As DisplayMode) As Boolean
  ...
  For Each DispMode As DisplayMode In Manager.Adapters(Adapter).SupportedDisplayModes(_DisplayMode.Format)
   If (DispMode.Width = _DisplayMode.Width) AndAlso _
      (DispMode.Height = _DisplayMode.Height) AndAlso _
      ((_DisplayMode.RefreshRate = 0) OrElse (DispMode.RefreshRate = _DisplayMode.RefreshRate)) Then _
    Return True

  Next DispMode ' For Each DispMode As DisplayMode In Manager.Adapters(Adapter).SupportedDisplayModes(_DisplayMode.Format)
 ...
 ''' </remarks>
 Public Function CheckDisplayMode(ByVal Adapter As Integer, ByVal Width As Integer, ByVal Height As Integer, Optional ByVal _Format As Format = Format.Unknown, Optional ByVal RefreshRate As Integer = 0) As Boolean
 ...
 ''' Thrown when validation fails for any parameter.
 ''' </exception>
 Public Function CheckBackBufferCount(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                      ByVal BackBufferWidth As Integer, ByVal BackBufferHeight As Integer, _
                                      ByVal BackBufferFormat As Format, ByVal DepthStencilFormat As DepthFormat, _
 ...
 Public Function CheckBackBufferCount(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                      ByVal BackBufferWidth As Integer, ByVal BackBufferHeight As Integer, _
                                      ByVal BackBufferFormat As Format, ByVal DepthStencilFormat As Format, _
                                      ByVal _MultiSampleType As MultiSampleType, ByVal Windowed As Boolean, _
                                      ByVal CheckCount As Integer) As Boolean
  ' Call the other function.
  Return CheckBackBufferCount(Adapter, _DeviceType, _
                              BackBufferWidth, BackBufferHeight, BackBufferFormat, _
                              CType(DepthStencilFormat, DepthFormat), _
 ...
 ''' </exception>
 Public Function CheckBackBufferCount(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                      ByVal _PresentParameters As PresentParameters, ByVal CheckCount As Integer) As Boolean
  ' Check if device type is supported.
  If Not CheckDeviceType(Adapter, _DeviceType) Then _
   Throw New ArgumentException("'CheckDeviceType' failed with given combination; " & _
                               "device creation will fail.") _
 : Exit Function
 ...
 : Exit Function
  ...
  If Not ValidatePresentParametersA(_PresentParameters) Then _
   Throw New ArgumentException("'ValidatePresentParametersA' failed; " & _
 ...
 ''' </remarks>
 Public Function CanCreateDevice(ByVal Adapter As Integer, ByVal _DeviceType As DeviceType, _
                                 ByVal _CreateFlags As CreateFlags, ByVal _PresentParameters As PresentParameters) As Boolean
  ' Check inputs.
  If _PresentParameters Is Nothing Then _
   Throw New ArgumentNullException("_PresentParameters") _
 : Exit Function
 ...
 ''' </remarks>
 Public Function CanCreateDeviceEx(ByRef Adapter As Integer, ByRef _DeviceType As DeviceType, _
                                   ByRef _CreateFlags As CreateFlags, ByVal _PresentParameters As PresentParameters) As Boolean
  ' Check inputs.
  If _PresentParameters Is Nothing Then _
   Throw New ArgumentNullException("_PresentParameters") _
 : Exit Function
