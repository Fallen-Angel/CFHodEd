...
Namespace Camera
 ...
 Public Class UserCamera
  ...
  Public Sub CameraPan(ByVal NewPos As Vector2, ByVal OldPos As Vector2, ByVal World As Matrix)
   ...
   Dim OldPos3 As Vector3 = Vector3.Unproject(New Vector3(OldPos.X, OldPos.Y, 0), _
                                              Viewport, _
                                              m_Proj, _
                                              m_View, _
                                              World)
   ...
   Dim NewPos3 As Vector3 = Vector3.Unproject(New Vector3(NewPos.X, NewPos.Y, 0), _
                                              Viewport, _
                                              m_Proj, _
                                              m_View, _
                                              World)
  ...
  Public Sub CameraRotate(ByVal Delta As Vector2)
   ...
   Dim M As Matrix = Matrix.RotationX(m_Rot.Y) * _
